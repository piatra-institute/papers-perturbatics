...
Barandiaran, X. E., Di Paolo, E., and Rohde, M. (2009). Defining agency: individuality, normativity, asymmetry, and spatio-temporality in action. *Adaptive Behavior*, 17(5), 367--386. — verified (DOI 10.1177/1059712309343819); agency distinct from intelligence, consciousness, personhood. Supports the instrument's deliberate silence on the latter three.

Barrett, J. L. (2000). Exploring the natural foundations of religion. *Trends in Cognitive Sciences*, 4(1), 29--34. — verified (DOI 10.1016/S1364-6613(99)01419-9); the hyperactive agency detection device. Supports the over-attribution the instrument corrects, and the grief-detector's parallel hyperactivity.
...
Kass, R. E., and Raftery, A. E. (1995). Bayes factors. *Journal of the American Statistical Association*, 90(430), 773--795. — verified (DOI 10.1080/01621459.1995.10476572); the agency score as a Bayes factor.

Klyubin, A. S., Polani, D., and Nehaniv, C. L. (2005). Empowerment: a universal agent-centric measure of control. In *Proceedings of the 2005 IEEE Congress on Evolutionary Computation*, 1, 128--135. — verified (DOI 10.1109/CEC.2005.1554676); empowerment. An alternative operationalization of agency.
...
Mayo, D. G. (2018). *Statistical Inference as Severe Testing: How to Get Beyond the Statistics Wars*. Cambridge: Cambridge University Press. — verified; severe testing. A model-separating probe as a severe test.
...
The inline reference list was migrated to references.yaml (CSL) and in-text citations to Pandoc [@id] syntax. Of the 73 entries, 29 were matched in Crossref by title, authors and year; 27 were resolved through doi.org content negotiation by hand (the 17 arXiv preprints through their DataCite DOIs 10.48550/arXiv.*, plus ten journal articles, chapters and books whose automatic match had failed); the remaining 17 were entered by hand: the NeurIPS, ICML and AISTATS papers from the proceedings pages at proceedings.neurips.cc and proceedings.mlr.press, van der Weij et al. from its ICLR 2025 OpenReview record, and the books from their publishers' details. Two automatic Crossref matches were wrong and were replaced: combes2013 had matched a book review of Combes's book, and lipsitch2010 had matched the journal's erratum notice.
Corrections from the records: the fourth author of Hardt et al. (2016) is Mary Wootters, not "M. Wu"; Manheim and Garrabrant's preprint (arXiv:1803.04585) dates from 2018, so the id is now manheim2018 and the in-text year 2018; Moore (1956) runs to page 154, not 153; Wang, Wiens and Lundberg (2021) is PMLR 130:721-729 (pages added). Source claims in claims.yaml were checked against abstracts retrieved from Crossref, OpenAlex, Europe PMC or the DataCite records of the arXiv preprints.
